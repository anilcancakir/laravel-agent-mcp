...
final class InstallMode
{
     ...
     *
     * Writes pretty JSON ({"mode":$mode,"version":1}) to path(). The file is meant
     * to be committed so the team, CI, and boost all resolve one mode.
     *
     * @param  string  $mode  One of modes().
     *
     * @throws InvalidArgumentException When $mode is not a supported mode.
     */
    public static function write(string $mode): void
    {
